...
\begin{tcolorbox}[width = 0.5\textwidth, boxrule = 0pt]
...
The environment \latexinline{PLTBoxItemize} is used to create a box for ecah item in a list. The current palette is used to choose the colors used in each box.
...
Numbered boxes are created using the \latexinline{PLTBoxEnumerate} environment.
