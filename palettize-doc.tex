...
The environment \latexinline{PLTBoxRaster} is used to create a box for ecah item in a list. The current palette is used to choose the colors used in each box.
...
Numbered boxes are created using the \latexinline{PLTBoxRaster} environment.
